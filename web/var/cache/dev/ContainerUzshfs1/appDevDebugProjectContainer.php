...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\controller\\bestelcontroller' => 'AppBundle\\Controller\\BestelController',
            ...
            'appbundle\\form\\type\\artikeltype' => 'AppBundle\\Form\\Type\\ArtikelType',
            'appbundle\\form\\type\\bestellingtype' => 'AppBundle\\Form\\Type\\BestellingType',
            'appbundle\\form\\type\\bestelregeltype' => 'AppBundle\\Form\\Type\\BestelregelType',
            'appbundle\\form\\type\\ontvangengoederentype' => 'AppBundle\\Form\\Type\\OntvangenGoederenType',
        ...
        $this->fileMap = array(
            ...
            'AppBundle\\Controller\\BestelController' => 'getBestelControllerService.php',
            ...
            'AppBundle\\Form\\Type\\ArtikelType' => 'getArtikelTypeService.php',
            'AppBundle\\Form\\Type\\BestellingType' => 'getBestellingTypeService.php',
            'AppBundle\\Form\\Type\\BestelregelType' => 'getBestelregelTypeService.php',
            'AppBundle\\Form\\Type\\OntvangenGoederenType' => 'getOntvangenGoederenTypeService.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Form\\Type\\ArtikelType' => true,
            'AppBundle\\Form\\Type\\BestellingType' => true,
            'AppBundle\\Form\\Type\\BestelregelType' => true,
            'AppBundle\\Form\\Type\\OntvangenGoederenType' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('bQWXRvSt5o', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PQb419wZ0C', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig\Environment(${($_ = isset($this->services['twig.loader']) ? $this->services['twig.loader'] : $this->getTwig_LoaderService()) && false ?: '_'}, array('debug' => true, 'strict_variables' => true, 'form_themes' => $this->parameters['twig.form.resources'], 'cache' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'charset' => 'UTF-8', 'default_path' => ($this->targetDirs[3].'/templates'), 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iUppO17lKO', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ReaIXOxefc', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bQe895hTiG', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
