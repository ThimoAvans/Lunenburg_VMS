...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\Type\\ArtikelType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\Type\ArtikelType']) ? $this->services['AppBundle\Form\Type\ArtikelType'] : $this->services['AppBundle\Form\Type\ArtikelType'] = new \AppBundle\Form\Type\ArtikelType()) && false ?: '_'};
}, 'AppBundle\\Form\\Type\\BestellingType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\Type\BestellingType']) ? $this->services['AppBundle\Form\Type\BestellingType'] : $this->services['AppBundle\Form\Type\BestellingType'] = new \AppBundle\Form\Type\BestellingType()) && false ?: '_'};
}, 'AppBundle\\Form\\Type\\BestelregelType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\Type\BestelregelType']) ? $this->services['AppBundle\Form\Type\BestelregelType'] : $this->services['AppBundle\Form\Type\BestelregelType'] = new \AppBundle\Form\Type\BestelregelType()) && false ?: '_'};
}, 'AppBundle\\Form\\Type\\OntvangenGoederenType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\Type\OntvangenGoederenType']) ? $this->services['AppBundle\Form\Type\OntvangenGoederenType'] : $this->services['AppBundle\Form\Type\OntvangenGoederenType'] = new \AppBundle\Form\Type\OntvangenGoederenType()) && false ?: '_'};
